...
@pytest.mark.parametrize(
    ...
    [(["Winter is coming"], "Winter is coming"), (None, ""), ([], ""), ([""], "")],
)
...
@pytest.mark.parametrize(
    "raw_language, expected_code",
    [(["English"], "1"), (["German"], "2"), (["NotExist"], ""), (None, ""), ([], "")],
)
...
@pytest.mark.parametrize(
    "raw_publisher, expected_publisher",
    [
